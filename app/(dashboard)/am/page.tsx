    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-lg bg-white p-6 shadow">
          <h3 className="text-sm font-medium text-gray-500">ยอดขายรวมพื้นที่</h3>
      ...
      {/* Branch Performance */}
      <div className="rounded-lg bg-white p-6 shadow">
        <h2 className="text-lg font-semibold text-gray-900">ผลงานสาขา</h2>
      ...
      {/* Top Staff */}
      <div className="rounded-lg bg-white p-6 shadow">
        <h2 className="text-lg font-semibold text-gray-900">Top 10 พนักงานขาย</h2>
        <div className="mt-4 text-center text-gray-500">
          <p>ยังไม่มีข้อมูล</p>
        </div>
      </div>
